...
class Order(models.Model):
    ...
    # last three fields will be calculated using a model method whenever an order is saved
    ...
    def _generate_order_number(self):
        """
        Generate random string of 32 characters, uniqe order nuber using UUID
        """
    ...
    def save(self, *args, **kwargs):
        """
        Overide the original save method to set the order
